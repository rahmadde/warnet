                  ...
                  <div class="card-body">
                    <form action="{{ route('bilings.update', $biling->id) }}" method="POST">
                            ...
                            <div class="form-group m-3">
                                ...
                                <input type="number" class="form-control @error('waktu_biling') is-invalid @enderror" name="waktu_biling" value="{{ old('waktu_biling', $biling->waktu_biling) }}" placeholder="Masukkan Waktu Biling /Jam">
                            ...
                            <div class="form-group m-3">
                                ...
                                <input type="date" class="form-control @error('tgl_pembelian') is-invalid @enderror" name="tgl_pembelian" value="{{ old('tgl_pembelian', $biling->tgl_pembelian) }}" placeholder="Masukkan Tanggal Pembelian">
