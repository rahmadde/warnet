              ...
              <div class="app-kanban">
                <div class="card">
                  <div class="card-header">
                    <h1>Biling</h1>
                    <a href="{{ route('bilings.create') }}" class="btn btn-md btn-success mb-3">Tambah Data</a>
                  </div>
                  <div class="card-body">
                    <table class="table table-bordered">
                      <thead>
                        <tr>
                          <th scope="col">Kode Biling</th>
                          <th scope="col">Waktu Biling /Jam</th>
                      ...
                      <tbody>
                        @forelse ($bilings as $biling)
                          <tr>
                              <td>{{ $biling->kd_biling }}</td>
                              <td>{{ $biling->waktu_biling }}</td>
                              <td>{{ $biling->id_member }}</td>
                              <td>{{ $biling->tgl_pembelian }}</td>
                              <td class="text-center">
                                  <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('bilings.destroy', $biling->id) }}" method="POST">
                                      <a href="{{ route('bilings.edit', $biling->id) }}" class="btn btn-sm btn-primary"><i class="fa-solid fa-pen-to-square"></i></a>
                                      @csrf
                                      @method('DELETE')
