                  ...
                  <div class="card-body">
                    <form action="{{ route('makanans.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group m-3">
                                ...
                                <input type="text" class="form-control @error('id_pemesanan') is-invalid @enderror" name="id_pemesanan" value="{{ old('id_pemesanan') }}" placeholder="Masukkan Id Pemesanan">
                            ...
                            <div class="form-group m-3">
                                ...
                                <input type="text" class="form-control @error('nm_makanan') is-invalid @enderror" name="nm_makanan" value="{{ old('nm_makanan') }}" placeholder="Masukkan Nama Makanan">
                            ...
                            <div class="form-group m-3">
                                ...
                                <input type="date" class="form-control @error('tgl_pemesanan') is-invalid @enderror" name="tgl_pemesanan" value="{{ old('tgl_pemesanan') }}" placeholder="Masukkan Tanggal Pemesanan">
