                  ...
                  <div class="card-body">
                    <form action="{{ route('members.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group m-3">
                                ...
                                <input type="text" class="form-control @error('nm_member') is-invalid @enderror" name="nm_member" value="{{ old('nm_member') }}" placeholder="Masukkan Nama Member">
                            ...
                            <div class="form-group m-3">
                                ...
                                <input type="number" class="form-control @error('no_hp') is-invalid @enderror" name="no_hp" value="{{ old('no_hp') }}" placeholder="Masukkan Nomor HP">
