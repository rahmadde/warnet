                  ...
                  <div class="card-body">
                    <form action="{{ route('members.update', $member->id) }}" method="POST">
                            ...
                            <div class="form-group m-3">
                                ...
                                <input type="text" class="form-control @error('id_member') is-invalid @enderror" name="id_member" value="{{ old('id_member', $member->id_member) }}" placeholder="Masukkan ID Member">
                            ...
                            <div class="form-group m-3">
                                ...
                                <input type="text" class="form-control @error('nm_member') is-invalid @enderror" name="nm_member" value="{{ old('nm_member', $member->nm_member) }}" placeholder="Masukkan Nama Member">
                            ...
                            <div class="form-group m-3">
                                ...
                                <input type="number" class="form-control @error('no_hp') is-invalid @enderror" name="no_hp" value="{{ old('no_hp', $member->no_hp) }}" placeholder="Masukkan Nomor HP">
                            ...
                            <div class="form-group m-3">
                                ...
                                <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" value="{{ old('password', $member->password) }}" placeholder="Masukkan Password">
